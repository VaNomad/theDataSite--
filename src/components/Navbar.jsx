...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      <div className={nav ? "opacity-0" : "flex"}>
      ...
      {/* Mobile Menu */}
      <div className={nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] opacity-[.9] ease-in-out duration-500" : "fixed top-[-100%] left-0 w-[60%] ease-in duration-300"}>
